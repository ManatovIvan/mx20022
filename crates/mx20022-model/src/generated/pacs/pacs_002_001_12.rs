...
impl DocumentBuilder {
    ...
    #[must_use]
    pub fn fi_to_fi_pmt_sts_rpt(mut self, value: FIToFIPaymentStatusReportV12) -> DocumentBuilder {
...
impl FIToFIPaymentStatusReportV12Builder {
    ...
    #[must_use]
    pub fn grp_hdr(mut self, value: GroupHeader101) -> FIToFIPaymentStatusReportV12Builder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<FIToFIPaymentStatusReportV12, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
...
impl GroupHeader101Builder {
    ...
    #[must_use]
    pub fn orgnl_biz_qry(mut self, value: OriginalBusinessQuery1) -> GroupHeader101Builder {
    ...
    /// Does not panic — all `.unwrap()` calls are guarded by the
    /// missing-field check above.
    pub fn build(self) -> ::std::result::Result<GroupHeader101, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
...
impl PaymentTransaction130Builder {
    ...
    #[must_use]
    pub fn orgnl_end_to_end_id(mut self, value: Max35Text) -> PaymentTransaction130Builder {
    ...
    #[must_use]
    pub fn orgnl_uetr(mut self, value: UUIDv4Identifier) -> PaymentTransaction130Builder {
    ...
    #[must_use]
    pub fn chrgs_inf(mut self, value: ::std::vec::Vec<Charges7>) -> PaymentTransaction130Builder {
    ...
    /// Append one item to the `splmtry_data` field.
    #[must_use]
    pub fn add_splmtry_data(mut self, value: SupplementaryData1) -> PaymentTransaction130Builder {
        self.splmtry_data.push(value);
        self
    }
    /// Validate required fields and construct the type.
